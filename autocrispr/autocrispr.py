...
Description:        User input is used to generate CRISPR oligos using pCas9 entry vectors designed by
...
class Options(Frame):
    ...
    def output(self):
        ...
        for entry in self.entries:
            oligo = Design_CRISPR_Oligos(entry[0].get(), entry[1].get(), entry[2].get())
